      ...
      <div class="card-body p-5">
        <div class="row justify-content-between">
          <div class="col">
            ...
            <a class="btn btn-primary btn-sm px-3 py-2"
              href="<?= base_url("admin/surat/index/" . $this->session->userdata('role')); ?>">
              Lihat Surat masuk
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <div class="chart-area">
          ...
          <canvas id="myAreaChart" width="668" height="320" class="chartjs-render-monitor"

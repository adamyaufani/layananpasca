...
<table style="width: 100%;">
  ...
  <p>Bermaksud untuk mengajukan kembali aktif perkuliahan semester <?= get_meta_value('semester', $surat['id'], false); ?> tahun akademik <?= get_meta_value('thn_akademik', $surat['id'], false); ?>. </p>  
  <p>Bersama ini kami lampirkan dokumen persyaratan yang dibutuhkan. </p>
